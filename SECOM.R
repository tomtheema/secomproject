...
# To further optimise the model performance to improve 'specificity', we employ class weights argument in train()
# Default we assign 1.5x weight for faulty wafers and 1x weight for good wafers.
class_weights_svm <- c("-1" = 1, "1" = 1.5)

# 4.1.1 - 4.1.3 knn_na
# Between the rose. smote, and adasyn training set; edit the data argument in train() function to respective balancing methods
knn_na_svm <- train(as.factor(label)~., data = knn_na_rose, method = "svmLinear", trControl = train_control_svm, class.weights = class_weights_svm)
...
# 4.2.1 - 4.2.3 knn_sd
knn_sd_svm <- train(as.factor(label)~., data = knn_sd_rose, method = "svmLinear", trControl = train_control_svm, class.weights = class_weights_svm)
...
knn_train_svm <- train(as.factor(label)~., data = knn_train_rose, method = "svmLinear", trControl = train_control_svm, class.weights = class_weights_svm)
...
# 4.4.1 - 4.4.5 train_knn_na
train_knn_na_svm <- train(as.factor(label)~., data = train_knn_na_rose, method = "svmLinear", trControl = train_control_svm, class.weights = class_weights_svm)
...
# 4.5.1 - 4.5.5 train_knn_sd
train_knn_sd_svm <- train(as.factor(label)~., data = train_knn_sd_rose, method = "svmLinear", trControl = train_control_svm, class.weights = class_weights_svm)
...
# 4.6.1 - 4.6.5 train_knn_out
train_knn_out_svm <- train(as.factor(label)~., data = train_knn_out_rose, method = "svmLinear", trControl = train_control_svm, class.weights = class_weights_svm)
...
# 4.10.1 - 4.10.5 train_hot_na
train_hot_na_svm <- train(as.factor(label)~., data = train_hot_na_rose, method = "svmLinear", trControl = train_control_svm, class.weights = class_weights_svm)
...
# 4.11.1 - 4.11.5 train_hot_sd
train_hot_sd_svm <- train(as.factor(label)~., data = train_hot_sd_rose, method = "svmLinear", trControl = train_control_svm, class.weights = class_weights_svm)
...
# 4.12.1 - 4.12.5 train_hot_out
train_hot_out_svm <- train(as.factor(label)~., data = train_hot_out_rose, method = "svmLinear", trControl = train_control_svm, class.weights = class_weights_svm)
